      ...
      <div className="container max-w-5xl py-12">
        <div className="flex flex-col items-center text-center mb-12 receipt-scanner-bg py-16">
          <h1 className="text-4xl font-bold tracking-tight mb-4">
            Une gestion intelligente de vos notes de frais
          </h1>
          <p className="text-xl text-muted-foreground max-w-2xl mb-8">
            Notre IA analyse vos tickets de caisse et s'adapte à votre façon de travailler pour une expérience sur mesure
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          <Card>
            <CardContent className="pt-6">
              ...
              <h3 className="font-semibold mb-2">S'adapte à Vous</h3>
              <p className="text-muted-foreground">
                L'application s'adapte à votre workflow et à vos préférences, pas l'inverse
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="pt-6">
              ...
              <h3 className="font-semibold mb-2">Traitement Automatisé</h3>
              <p className="text-muted-foreground">
                Extraction intelligente des données et catégorisation automatique de vos dépenses
              </p>
            </CardContent>
          </Card>
        </div>
